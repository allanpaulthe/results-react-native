...
export default class collegesignupScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      user: '',
        ...
        <View style={styles.inputWrap}>
          ...
          <View style={styles.inputWrap}>
            ...
            <TextInput 
              ...
              style={styles.input} 
              secureTextEntry 
              onChangeText={(pass) => {this.setState({pass});this.state.validate[2]=true}}
            />
          </View>
          <TouchableOpacity activeOpacity={.5}
          onPress={() => this.clsignup(navigate,this.state)}
          >
